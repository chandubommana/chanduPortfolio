...
export function HeroSection() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-1/3 right-10 w-16 h-16 bg-orange/40 rotate-45 blur-md animate-spin" style={{ animationDuration: '20s' }} />
          ...
          <div className="text-left animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Button
                ...
                className="bg-orange hover:bg-orange/90 text-white hover:shadow-glow transition-smooth group px-8 py-3"
              >
                View My Work
              ...
              <Button
                ...
                className="border-white/30 text-white hover:border-white hover:bg-white/10 transition-smooth px-8 py-3"
              >
            ...
            <div className="flex gap-4">
              <Button
                variant="ghost"
                size="icon"
                className="hover:text-orange hover:bg-white/10 text-white/80 transition-smooth"
                asChild
              >
                <a
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <Button
          ...
          className="hover:text-orange text-white/80 transition-smooth"
